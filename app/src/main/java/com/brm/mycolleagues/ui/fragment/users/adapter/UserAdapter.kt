package com.brm.mycolleagues.ui.fragment.users.adapter
...
import com.brm.mycolleagues.databinding.WorkerListNoTimeBinding
...
class UserAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {
    ...
    private class ListViewHolder(private val binding: WorkerListNoTimeBinding): RecyclerView.ViewHolder(binding.root){
        ...
        companion object{
            fun from(parent: ViewGroup): ListViewHolder{
                val bind = WorkerListNoTimeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
